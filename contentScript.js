...
spywareButton.onclick = async () => {
  if (loopState == "pause" || loopState == "idle") {
    ...
    await handleSaveClick(
      $("img.search-post").not($("img.search-post.clicked"))[0]
    );
    saveLoop();
  } else {
    spywareButton.src = chrome.runtime.getURL("img/spyware.png");
    ...
    mutationList.forEach((e) => {
      if (e.type == "childList") {
        if (location.pathname.match(/^\/groups\/[\d\w]+$/)) {
          insertSaveButton(
            "span.d2edcug0.hpfvmrgz.qv66sw1b.c1et5uql.lr9zc1uh.a8c37x1j.keod5gw0.nxhoafnm.aigsh9s9.d9wwppkn.fe6kdd0r.mau55g9w.c8b282yb.mdeji52x.e9vueds3.j5wam9gi.knj5qynh.m9osqain.hzawbc8m>span",
            "feed-post"
          );
          insertSaveButton(
            "ul._6coi.oygrvhab.ozuftl9m.l66bhrea.linoseic",
            "feed-comment"
          );
        }
        if (location.pathname.match(/^\/groups\/\d+\/search/)) {
          insertSaveButton(
            "span.a8c37x1j.ni8dbmo4.stjgntxs.l9j0dhe7.nkwizq5d.roh60bw9.hop8lmos.scwd0bx6.n8tt0mok.hyh9befq.jwdofwj8.r8blr3vg",
            "search-post"
          );
          insertSaveButton(
            "ul._6coi.oygrvhab.ozuftl9m.l66bhrea.linoseic",
...
function insertSaveButton(anchorSelector, typeOfAnchor) {
  ...
  ANCHOR_COLLECTION.not(
    ANCHOR_COLLECTION.has("img.fbsaver-save-button")
  ).append(saveButton);
...
async function handleSaveClick(e) {
  ...
  try {
    ...
    await fetch(
      "https://script.google.com/macros/s/AKfycbwZqapZno2sHVCRVjrh0O-ZxB9K94ecIQrEPDBWZsnp6-0iEPmHNxETh6wbKPM-uQLT/exec",
      {
        method: "POST",
...
function getPayLoad(target) {
  ...
  switch (target.classList[1]) {
    case "feed-post":
      payLoad.uid = $(target)
        .parents("div.j83agx80.cbu4d94t.ew0dbk1b.irj2b8pg")
        .find(
      ...
      payLoad.postId = $(target)
        ...
        .href.match(/(\/permalink\/)(\d+)/)[2];
      break;
    case "feed-comment":
      payLoad.uid = $(target)
        .parents("div.g3eujd1d.ni8dbmo4.stjgntxs.hv4rvrfc")
        .find(
      ...
      payLoad.postContent = $(target)
        .parents("div.g3eujd1d.ni8dbmo4.stjgntxs.hv4rvrfc")
        .find("div.kvgmc6g5.cxmmr5t8.oygrvhab.hcukyx3x.c1et5uql")[0]
        ? $(target)
            .parents("div.g3eujd1d.ni8dbmo4.stjgntxs.hv4rvrfc")
            .find("div.kvgmc6g5.cxmmr5t8.oygrvhab.hcukyx3x.c1et5uql")[0]
            .innerText
      ...
      payLoad.postId = $(target)
        ...
        .find("a")[0]
        .href.match(/(\/permalink\/)(\d+)/)[2];
      payLoad.commentId = $(target)
        .parent()
        .find("a")[0]
        .href.match(/(\?comment_id=)(\d+)/)[2];
      payLoad.replyCommentId = $(target)
        .parent()
        .find("a")[0]
        .href.match(/(reply_comment_id=)(\d+)/)
        ? $(target)
            .parent()
            .find("a")[0]
            .href.match(/(reply_comment_id=)(\d+)/)[2]
        : "";
      break;
    case "search-post":
      payLoad.uid = $(target)
      ...
      payLoad.postContent = $(target)
        ...
        .find("span.a8c37x1j.ni8dbmo4.stjgntxs.l9j0dhe7")[1].childNodes[1].data;
      payLoad.postId = $(target)
        .parents(
          "div.rq0escxv.l9j0dhe7.du4w35lb.hybvsw6c.io0zqebd.m5lcvass.fbipl8qg.nwvqtn77.k4urcfbm.ni8dbmo4.stjgntxs.sbcfpzgs"
        )
        .find(
          "a.oajrlxb2.g5ia77u1.qu0x051f.esr5mh6w.e9989ue4.r7d6kgcz.rq0escxv.nhd2j8a9.a8c37x1j.p7hjln8o.kvgmc6g5.cxmmr5t8.oygrvhab.hcukyx3x.jb3vyjys.rz4wbd8a.qt6c0cv9.a8nywdso.i1ao9s8h.esuyzwwr.f1sip0of.lzcic4wl.gmql0nx0.p8dawk7l"
        )[0]
        .href.match(/(\/permalink\/)(\d+)/)[2];
      break;
    case "search-comment":
...
async function saveLoop() {
  if (
    $("img.search-post").not($("img.search-post.clicked"))[0] == undefined &&
    $(
      "span.d2edcug0.hpfvmrgz.qv66sw1b.c1et5uql.lr9zc1uh.a8c37x1j.keod5gw0.nxhoafnm.aigsh9s9.d3f4x2em.fe6kdd0r.mau55g9w.c8b282yb.iv3no6db.jq4qci2q.a3bd9o3v.knj5qynh.m9osqain.oqcyycmt"
    )[0] !== undefined
  ) {
    spywareButton.src = chrome.runtime.getURL("img/spyware.png");
